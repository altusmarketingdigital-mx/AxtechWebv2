      ...
      <body className={`${inter.className} min-h-full flex flex-col bg-background text-foreground`}>
        ...
        <div className="fixed bottom-6 right-6 z-50 group">
          ...
          <a 
            ...
            className="relative flex items-center justify-center bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 hover:shadow-[0_10px_20px_rgba(37,211,102,0.4)] transition-all"
            aria-label="WhatsApp"
          >
