      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center space-x-3">
            <Link 
              href="/tienda" 
              className="flex items-center gap-1.5 px-3.5 py-2 bg-white border border-gray-200 rounded-xl hover:bg-gray-100 text-sm font-bold text-gray-700 transition"
            >
              <ArrowLeft size={18} />
            ...
            <Link 
              href="/" 
              className="px-3.5 py-2 bg-gray-100 hover:bg-gray-200 text-xs font-semibold text-gray-600 rounded-xl transition"
            >
              Regresar a Página
            </Link>
          </div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Tu Carrito de Compras</h1>
        </div>
